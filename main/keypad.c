...
static callback_get_key  _callback_key= NULL;
static callback_get_buffer  _callback_buffer = NULL;
static callback_clear     _callback_clear = NULL;
...
void keypad_init( callback_get_key callback_key_pressed,
    ...
    _callback_key = callback_key_pressed;
    _callback_buffer = callback_get_buffer;
